  ...
  return (
    <DashboardShell>
      ...
      <div className="mira-stagger mb-4 grid grid-cols-1 gap-4 md:grid-cols-[1.4fr_1fr]">
        <div className="relative overflow-hidden rounded-[20px] border border-[#f2e4d8] bg-gradient-to-br from-[#fffaf6] via-[#fff4ec] to-[#ffece0] p-[30px] shadow-[0_24px_60px_-40px_rgba(249,115,22,0.4)]">
          <div
          ...
          <div className="relative">
            ...
            <h2 className="m-0 mb-2 text-2xl font-bold tracking-[-0.01em] text-[#0a0a0a]">
              准备一场新的面试
            </h2>
            <p className="m-0 mb-6 max-w-[320px] text-sm leading-[1.55] text-[#78716c]">
      ...
      <div className="animate-mira-soft-pop overflow-hidden rounded-[20px] border border-[#eee] bg-white [animation-delay:.16s]">
        <div className="flex items-center justify-between border-b border-[#f2f2f2] px-6 py-5">
          <div>
            ...
            <p className="m-0 mt-0.5 text-[12.5px] text-[#a3a3a3]">
              面试题目会围绕这些简历生成
            </p>
          </div>
          <label
            htmlFor="resume-upload"
            className="mira-button flex cursor-pointer items-center gap-1.5 rounded-[10px] bg-[#fff5ee] px-3.5 py-2 text-[13px] font-medium text-orange-600 hover:bg-[#ffece0]"
          >
        ...
        <div>
          {resumes.map((r) => (
            <div
              key={r.id}
              className="mira-button flex items-center gap-3.5 border-b border-[#f5f5f5] px-6 py-4 last:border-b-0 hover:bg-[#fafafa]"
            >
              <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-[10px] bg-[#fff5ee] font-display text-[11px] font-bold text-orange-500">
                PDF
              </span>
              ...
              <button className="mira-button rounded-lg px-3 py-1.5 text-[12.5px] text-[#737373] hover:bg-[#f0f0f0] hover:text-[#0a0a0a]">
                查看
              </button>
              <Link
                href="/interview/setup"
                transitionTypes={["nav-forward"]}
                className="mira-button rounded-lg px-3 py-1.5 text-[12.5px] font-medium text-orange-500 hover:bg-[#fff5ee]"
              >
                用它面试 →
              </Link>
            </div>
