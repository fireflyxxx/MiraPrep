  ...
  return (
    <DashboardShell>
      ...
      <div className="mira-stagger mb-4 grid grid-cols-1 gap-4 md:grid-cols-[1fr_1.5fr]">
        <div className="mira-surface flex flex-col justify-between rounded-[20px] border border-border-subtle bg-surface p-[26px]">
        ...
        <div className="mira-surface rounded-[20px] border border-border-subtle bg-surface p-[26px]">
        ...
        <div>
          {interviewHistory.map((item, i) => (
            <Link
              ...
              className={`mira-button grid cursor-pointer grid-cols-[1fr_auto_auto_auto] items-center gap-5 px-6 py-4 hover:bg-surface-subtle ${
                i < interviewHistory.length - 1 ? "border-b border-muted" : ""
              }`}
            >
              ...
              <span className="text-[12.5px] text-muted-foreground">{item.when}</span>
